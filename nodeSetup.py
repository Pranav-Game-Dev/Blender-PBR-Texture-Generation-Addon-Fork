...
class nodeSetup:
    ...
    def main(directory, name):    
        ...
        in_put = ['Vector', 'Vector', 'Vector', 'Vector',  'Vector',   'Vector', 'Color',   'Color',    'Color',          'Color',           'Color',      'Color1',  0,             0,                   0,                    0,               'Color2',      'Height',        'Base Color',     'IOR',               'Roughness',          'Color1',  'Color2', 'Color2',   'Color1',  'Color',   'Color',    'Normal']
